...
dummy_joint_names = ['front_left_wheel', 'front_right_wheel', 'rear_left_wheel', 'rear_right_wheel']
...
def joint_states_callback(msg):
    lock_ob.acquire()
    global joint_states
    # for joint_idx, joint_name in enumerate(msg.name):
    #     if joint_name in conf_joint_names:
    #         joint_states.name.append(joint_name)
    #         joint_states.position.append(msg.position[joint_idx])
    #         joint_states.velocity.append(msg.velocity[joint_idx])
    #         joint_states.effort.append(msg.effort[joint_idx])
    joint_states = msg

    lock_ob.release()

    new_joint_states = joint_states
